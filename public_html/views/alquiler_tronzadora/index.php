<?php
$metaTitle = "Alquiler de Tronzadora | ST América";
$metaDescription = "Alquiler de tronzadora en ST América, ideal para trabajos de construcción y remodelación. Equipos de seguridad y medición disponibles con entrega inmediata.";
$metaKeywords = "tronzadora, alquiler, alquiler de tronzadora, equipos de seguridad, alquiler de equipos de seguridad, st américa";
?>
    ...
    <div class="row px-xl-5">
        <div class="col-12">
            <nav class="breadcrumb bg-light mb-30">
                ...
                <span class="breadcrumb-item active">Alquiler de Tronzadora</span>
            </nav>
        </div>
    </div>
</div>
            ...
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner bg-light">
                    <div class="carousel-item active">
                        <img class="w-100 h-100" src="public/img/EquiposAlquiler/Construccion/Tronzadora.png" alt="Image">
                    </div>
        ...
        <div class="col-lg-7 h-auto mb-30">
            <div class="h-100 bg-light p-30">
                ...
                <div class="d-flex mb-3">
                    ...
                    <form>
                        <div class="custom-control custom-radio custom-control-inline">
                            <label class="custom-control-label" for="size-1">D28730</label>
                        </div>
                    </form>
                </div>
                <div class="d-flex align-items-center mb-4 pt-2">

                    <button class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> <a title="Click para chatear" href="https://api.whatsapp.com/send?phone=+51941683636&text=Me%20gustaría%20alquilar%20el%20siguiente%20equipo:%20Tronzadora" target="_blank" rel="noopener">Alquilar Producto</a></button>
                </div>
