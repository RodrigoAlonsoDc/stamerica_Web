...
<div class="container-fluid bg-dark text-secondary pt-5">
    <div class="row px-xl-5 pt-5">
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            ...
            <br><br>
            <p class="mb-4">Somos su mejor opción a la hora de elegir un proveedor de equipos de medición, equipos de construcción y equipos de seguridad. [Despliegue 100% Automático desde Antigravity IDE]</p>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-5">
                    ...
                    <iframe
                        ...
                        allowfullscreen=""
                        loading="lazy"
                        title="Ubicación ST América - San Hilarión Alto"
    ...
    <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
        <div class="col-md-6 px-xl-0">
            <p class="mb-md-0 text-center text-md-left text-secondary">
                &copy; <a style="color: #4156a5;" href="">Copyright</a> ST América S.R.L.
                <a style="color: #4156a5;" href="">Todos los derechos reservados</a>
            </p>
        </div>
...
<a href="#" class="redes btn back-to-top"><i class="fa fa-angle-double-up"></i></a>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
<link rel="stylesheet" href="public/css/footer.css">
<a href="https://api.whatsapp.com/send?phone=51941683636&text=Desde%20la%20Web:%20Hola%20me%20brindarías%20mas%20información%20sobre%20servicios%20eléctricos.%20" alt="Contáctanos por WhatsApp" class="float" target="_blank" style="margin-right: 50px;">
