<?php
$metaTitle = "Venta de Cable NH-80 Libre de Halogenos | ST América";
$metaDescription = "En ST América ofrecemos servicios especializados en la venta de Cable NH-80 Libre de Halogenos, garantizando soluciones eficientes y seguras para tus proyectos eléctricos.";
$metaKeywords = "Cable NH-80 Libre de Halogenos, venta de cables eléctricos, soluciones eléctricas, ST América";
?>
    ...
    <div class="row px-xl-5">
        <div class="col-12">
            <nav class="breadcrumb bg-light mb-30">
                ...
                <span class="breadcrumb-item active">Venta de Cable NH-80 Libre de Halogenos</span>
            </nav>
        </div>
    </div>
</div>
    ...
    <div class="row px-xl-5">
            ...
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner bg-light">
                    <div class="carousel-item active">
                        <img class="w-100 h-100" src="public/img/Suministros/Cables/Para Alonsoooo_Mesa de trabajo 1 copia 35.png" alt="Image">
                    </div>
        ...
        <div class="col-lg-7 h-auto mb-30">
            <div class="h-100 bg-light p-30">
                <h1>Cable NH-80 Libre de Halogenos</h1>
                ...
                <div class="d-flex mb-3">
                    ...
                    <form>
                        <div class="custom-control custom-radio custom-control-inline">
                            <label class="custom-control-label" for="size-1">COMPUESTO TERMOPLASTICO LIBRE DE HALOGENOS</label>
                        </div>
                    </form>
                </div>
                <div class="d-flex mb-3">
                    ...
                    <form>
                        <div class="custom-control custom-radio custom-control-inline">
                            <label class="custom-control-label" for="size-1">INDECO</label>
                        </div>
                    </form>
                </div>
                <div class="d-flex mb-3">
                    <strong class="text-dark mr-3">SECCIÓN:</strong>
                    <form>
                        <div class="custom-control custom-radio custom-control-inline">
                            <label class="custom-control-label" for="size-1">16MM2 HASTA 300MM2</label>
                        </div>
                    </form>
                </div>
                <div class="d-flex align-items-center mb-4 pt-2">

                    <button class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> <a title="Click para chatear" href="https://api.whatsapp.com/send?phone=+51941683636&text=Hola.%20Me%20gustaría%20adquirir%20el%20siguiente%20cable:%20Cable+NH-80+Libre+de+Halogenos" target="_blank" rel="noopener">Adquirir Producto</a></button>
                </div>
