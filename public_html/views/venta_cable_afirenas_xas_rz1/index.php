<?php
$metaTitle = "Venta de Cable Afirenas-X(AS) RZ1-K | ST América";
$metaDescription = "En ST América ofrecemos servicios especializados en la venta de Cable Afirenas-X(AS) RZ1-K, garantizando soluciones eficientes y seguras para tus proyectos eléctricos.";
$metaKeywords = "Cable Afirenas-X(AS) RZ1-K, venta de cables eléctricos, soluciones eléctricas, ST América";
?>
    ...
    <div class="row px-xl-5">
        <div class="col-12">
            <nav class="breadcrumb bg-light mb-30">
                ...
                <span class="breadcrumb-item active">Venta de Cable Afirenas-X(AS) RZ1-K</span>
            </nav>
        </div>
    </div>
</div>
    ...
    <div class="row px-xl-5">
            ...
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner bg-light">
                    <div class="carousel-item active">
                        <img class="w-100 h-100" src="public/img/Suministros/Cables/Para Alonsoooo_Mesa de trabajo 1 copia 28.png" alt="Image">
                    </div>
        ...
        <div class="col-lg-7 h-auto mb-30">
            <div class="h-100 bg-light p-30">
                <h3>Cable Afirenas-X(AS) RZ1-K</h3>
                ...
                <p class="mb-4">Conductor de cobre electrolítico, recocido, flexible de clase 5 según UNE EN 60228 / EN 60228 / IEC 60228.</p>
                <ul>
                ...
                <div class="d-flex mb-3">
                    <strong class="text-dark mr-3">TENSIÓN NOMINAL:</strong>
                    <form>
                        <div class="custom-control custom-radio custom-control-inline">
                            <label class="custom-control-label" for="size-1">0,6 / 1 (1,2) kV C.A Uo/U (Um) / 1,5 kV C.C. (Umáx =1,8 kV C.C)</label>
                        </div>
                    </form>
                </div>
                <div class="d-flex mb-3">
                    <strong class="text-dark mr-3">TENSIÓN DE ENSAYO:</strong>
                    <form>
                        <div class="custom-control custom-radio custom-control-inline">
                            <label class="custom-control-label" for="size-1">En corriente alterna 3,5 kV</label>
                        </div>
                    </form>
                </div>
                <div class="d-flex mb-3">
                    <strong class="text-dark mr-3">REACCIÓN AL FUEGO:</strong>
                    <form>
                        <div class="custom-control custom-radio custom-control-inline">
                            <label class="custom-control-label" for="size-1">Cca-s1b,d1,a1</label>
                        </div>
                    </form>
                </div>
                <div class="d-flex align-items-center mb-4 pt-2">

                    <button class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> <a title="Click para chatear" href="https://api.whatsapp.com/send?phone=+51941683636&text=Hola.%20Me%20gustaría%20adquirir%20el%20siguiente%20cable:%20Cable+ Afirenas-X(AS)+RZ1-K+" target="_blank" rel="noopener">Adquirir Producto</a></button>
                </div>
